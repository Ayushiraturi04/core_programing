...
public class EmployeeBonus {
    ...
    private static double[][] calculateBonusAndNewSalary(double[][] data) {
        double[][] updatedData = new double[data.length][3]; // [][0] -> Old Salary, [][1] -> Years of Service, [][2] ->
                                                             // Bonus & New Salary
        for (int i = 0; i < data.length; i++) {
            ...
            // Store old salary, years of service, and new salary with bonus in the
            // updatedData array
    ...
    private static void displayResults(double[][] oldData, double[][] updatedData) {
        ...
        System.out.println("--------------------------------------------------");
        System.out.printf("%-10s %-20s %-15s %-15s %-15s\n", "Employee", "Old Salary", "Years of Service", "New Salary",
                "Bonus");
